...
<html lang="en">
    ...
    <style>
        ...
        #blankSpace {
            width: 75%;
            height: 100%;
            background-color: #f5f5f5; /* Light grey to indicate blank space */
        }
    </style>
    </head>
    <body>
    ...
    <div class="ticket  show card-body">
                   ...
                   <!-- PDF Preview Section (Left 25%) -->
    <div id="pdfContainer">
        <iframe id="pdfViewer"></iframe>
    </div>

    <!-- Blank Space (Right 75%) -->
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            html2canvas(document.querySelector(".ticket")).then(canvas => {
                ...
                // Set the PDF preview inside iframe
                document.getElementById("pdfViewer").src = pdf.output('bloburl');
                
                // Optionally, remove the original HTML content
                document.body.innerHTML = document.getElementById("pdfContainer").outerHTML;
            });
        });
    </script>
